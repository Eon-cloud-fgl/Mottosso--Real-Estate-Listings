    ...
    <div className="hero-container">
      ...
      <div className="hero-content">
        ...
        <p className="hero-subtitle">
          propiedadesmottoso.com es su destino ideal para encontrar la casa de
          alquiler perfecta para satisfacer sus necesidades..
        </p>
        <OpenEstate />
      </div>
...
function Bar() {
  ...
  return (
    <div className="hero-form-bar">
      <div className="hero-form-bar--input" style={{ position: "relative" }}>
        <input
          type="text"
          value={query}
          onChange={handleChangeQuery}
          onKeyDown={handleKeyDown}
          placeholder="Buscar por Ficha o Zona..."
          autoComplete="off"
        />
...
function DescriptionItem() {
  return (
    <div className="cd-item">
      ...
      <p>
        En Mottoso Propiedades te ayudamos a encontrar el lugar ideal para vivir
        o invertir. Con asesoramiento profesional y una amplia variedad de
        opciones, hacemos que tu próxima propiedad esté más cerca.
      </p>
    </div>
  );
}
...
function ImageItem() {
  return (
    <div className="image-stack">
      <img
        src="/info-banner-1.avif"
        alt="Imagen 1"
        className="stack-img img-1"
      />
      <img
        src="/img/home-visual-1.jpg"
        alt="Imagen 2"
        className="stack-img img-2"
      />
      <img
        src="/img/home-visual-2.jpg"
        alt="Imagen 3"
        className="stack-img img-3"
      />
      <img
        src="/img/home-visual-3.jpg"
        alt="Imagen 4"
        className="stack-img img-4"
      />
    </div>
  );
}
    ...
    <div className="contenedor-mayor">
      ...
      <div className="miscellaneous-items">
        <MisItems
          imageN={1}
          title="Propiedades"
          info="Destacadas Explorá los hogares más buscados, listos para mudarte o invertir."
          option="estate"
        />
        <MisItems
          imageN={2}
          title="Asesoramiento"
          info="Te acompañamos en cada paso para que tomes la mejor decisión."
          option="contact"
        />
        <MisItems
          imageN={3}
          title="Tasaciones"
          info="Te ayudamos a darle el valor que merece a tu hogar."
          option="appraisals"
        />
      </div>
    </div>
