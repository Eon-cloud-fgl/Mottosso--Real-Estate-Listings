...
function Description() {
  return (
    <div className="ds-container">
      ...
      <p>
        Realizamos el análisis de su inmueble basado en un profundo análisis,
        para brindar un valor real del mercado, tomando en cuenta la ubicación,
        superficie, comodidades y las características únicas de tu hogar.
      </p>
      ...
      <div className="property-types">
        ...
        <ul>
          <li>
            <span className="icon-descripcion">
              <FaHome />
            </span>
            Casas
          </li>
  ...
  return (
    <div className="form-container">
      ...
      <form onSubmit={handleSubmit} className="appraisal-form">
        {/* Paso 0 */}
        <div className={`form-step ${step !== 0 ? "hidden" : ""}`}>
        ...
        {/* Paso 1 */}
        <div className={`form-step ${step !== 1 ? "hidden" : ""}`}>
        ...
        {/* Paso 2 */}
        <div className={`form-step ${step !== 2 ? "hidden" : ""}`}>
        ...
        {/* Paso 3 */}
        <div className={`form-step ${step !== 3 ? "hidden" : ""}`}>
        ...
        {/* Paso 4 */}
        <div className={`form-step ${step !== 4 ? "hidden" : ""}`}>
